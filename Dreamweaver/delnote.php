...
if ((isset($_POST['id'])) && ($_POST['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM notes WHERE id=%s",
                       GetSQLValueString($_POST['id'], "int"));

  mysql_select_db($database_Dreamweaver, $Dreamweaver);
  $Result1 = mysql_query($deleteSQL, $Dreamweaver) or die(mysql_error());
...
<hr>
<form action="" method="post" name="delete_note">
<input name="id" type="hidden" value="<?php echo $row_note['id']; ?>" /><br />
<input name="title" type="text" readonly="readonly" value="<?php echo $row_note['title']; ?>" /><br />
<textarea name="article" cols="" rows="" readonly="readonly"><?php echo $row_note['article']; ?></textarea><br />
<input name="submit" type="submit" value="Видалити" />
</form>
</body>
</html>
<?php
