...
$query_privileges = "SELECT * FROM `privileges`";
$privileges = mysql_query($query_privileges, $Dreamweaver) or die(mysql_error());
...
<table width="200" border="1">
  ...
  <tr>
    ...
    <td><?php echo $row_privileges['rights']; ?></td>
  </tr>
  <?php } while ($row_privileges = mysql_fetch_assoc($privileges)); ?>
</table>
<a href="adduser.php">Створити нового користувача</a>
</body>
</html>
<?php
mysql_free_result($privileges);
?>
