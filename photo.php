...
while (($path_to_file = readdir($image_dir_id)) !== false) {
    if ($path_to_file !== '.'
        && $path_to_file !== '..'
        && startsWith(mime_content_type($image_dir_path . '/' . $path_to_file), 'image/')) {
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item active"><a class="nav-link" href="photo.php">Фото <span
        ...
        <div class="container">
            <div class="row">
                <form name="file_upload" action="photo.php" enctype="multipart/form-data" method="post">
                    ...
                    <div class="custom-file my-2">
                        <input type="file" accept="image/*" class="custom-file-input" id="photoInput"
                               name="file_upload">
                        <label class="custom-file-label" for="photoInput">Обрати фото</label>
                    </div>
            ...
            <div class="row">
                <table class="table my-2">
                    <thead>
                    <tr><th scope='col'>#</th><th scope='col'>Photo</th></tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    <label>
                        <div class='input-group mb-3'>
                            <div class='input-group-prepend'>
                                <label class='input-group-text' for='deleteSelect'>Фото</label>
                            </div>
